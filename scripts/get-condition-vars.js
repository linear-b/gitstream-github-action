...
module.exports = core => {
  ...
  try {
    ...
    console.log(`yeela-debug get-condtion-vars types: payload.isNonCommitEvent type: ${typeof(payload.isNonCommitEvent)}, ENABLE_CACHE_ARG type: ${typeof(ENABLE_CACHE_ARG)}`, CLIENT_PAYLOAD_ARG, ENABLE_CACHE_ARG)
